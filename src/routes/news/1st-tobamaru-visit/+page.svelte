...
<MetaTags
  title="第一回 鳥羽丸見学を実施しました"
  description="鳥羽商船学生対象の鳥羽丸見学を実施しました。"
...
<main>
  <article>
    ...
    <div>
      <p>
        4月21日に鳥羽丸プロジェクトの中で初めての鳥羽丸見学会を実施しました！
      </p>
      <p>
        商船学科の学生だけでなく、情報機械システム工学科の1年生も3人参加してもらい、
        ブリッジ（船橋）（操舵をする部屋）を見学してもらいました。
      </p>
    </div>
  </article>
